...
Високата кохезия означава, че елементите са тясно свързани и фокусирани върху една цел, докато ниската кохезия означава, че елементите са слабо свързани и служат за множество цели.

⚪**Coupling**

Ние искаме да имаме low cupling.           
Високото свързване означава, че модулите са тясно свързани и промените в един модул могат да засегнат други модули. Ниското свързване означава, че модулите са независими и промените в един модул имат малко влияние върху други модули.
