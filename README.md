...
High cupling означава, че модулите са тясно свързани и промените в един модул могат да засегнат други модули. Low cupling означава, че модулите са независими и промените в един модул имат малко влияние върху други модули.
