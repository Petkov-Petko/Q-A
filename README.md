...
Функция се трансформира в последователност от функции, като всяка приема само един аргумент. Резултатът е нова функция, която може да се извиква с поредица от аргументи един по един, като произвежда същия резултат, както ако всички аргументи бяха предадени на оригиналната функция наведнъж.
